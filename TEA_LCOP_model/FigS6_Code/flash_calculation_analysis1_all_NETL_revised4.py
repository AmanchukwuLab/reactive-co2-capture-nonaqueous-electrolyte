...
input_parameter = pd.read_csv('Analysis_one_7new.csv')
print(input_parameter)
case = 7  # this will be the only parameters to enter for choosing parameters to run
#definition of cases
...
df.to_csv('cost_Analysis1_case_'+str(case)+'.csv')
df_2.to_csv('stream_Analysis1_table_'+str(case)+'.csv')
df_netl.to_csv('cost_netl_Analysis1_case_'+str(case)+'.csv')

"""
df.to_csv('cost_information_reggie_case_'+str(case)+'.csv')
df_2.to_csv('stream_reggie_case_'+str(case)+'.csv')
df_netl.to_csv('cost_netl_reggie_case_'+str(case)+'.csv')
"""
