...
df.to_csv('cost_Analysis2_'+str(case)+'_main.csv')
df_2.to_csv('stream_Analysis2_table_'+str(case)+'_main.csv')
df_netl.to_csv('cost_netl_Analysis2_'+str(case)+'_main.csv')
