...
cost_input_parameter = pd.read_csv('input_Current_FE_10K.csv')
#print(cost_input_parameter)
cost_case = case_number_to_be_changed   # this will be the only parameters to enter for choosing parameters to run
#definition of cases


input_parameter = pd.read_csv('Analysis_two_updated_Ni.csv')
...
v = {}
v['COER']  = cost_input_parameter.loc[cost_case,'FE']
v['HER']   = 0.109 #1 - cost_input_parameter.loc[cost_case,'FE']
vv = {}
...
jTot_Cat      =  cost_input_parameter.loc[cost_case,'current density']  #this is a parameter to be supplied, total charge density
...
#==========cost coefficent===================
C_Catmat   = 1.15*input_parameter.loc[case,'cost of cathode material'] #====$/g======================
#C_Anmat    = 16500

C_Anmat    = 1.15*input_parameter.loc[case,'cost of anode material']   #====$/g======================
...
df.to_csv('./Analysis3_Zn_FE_Current_Ni/cost_Analysis3_case_'+str(cost_case)+'.csv')
df_2.to_csv('./Analysis3_Zn_FE_Current_Ni/stream_Analysis3_table_'+str(cost_case)+'.csv')
df_netl.to_csv('./Analysis3_Zn_FE_Current_Ni/cost_netl_Analysis2_'+str(cost_case)+'_main.csv')
