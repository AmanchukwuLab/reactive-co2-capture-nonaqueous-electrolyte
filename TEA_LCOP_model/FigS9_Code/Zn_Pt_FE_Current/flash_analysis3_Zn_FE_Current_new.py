...
df.to_csv('./Analysis3_Zn_FE_Current/cost_Analysis3_case_'+str(cost_case)+'.csv')
df_2.to_csv('./Analysis3_Zn_FE_Current/stream_Analysis3_table_'+str(cost_case)+'.csv')
df_netl.to_csv('./Analysis3_Zn_FE_Current/cost_netl_Analysis2_'+str(cost_case)+'_main.csv')
