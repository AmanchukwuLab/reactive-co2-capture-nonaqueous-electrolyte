...
#input_parameter.loc[case,'total current density']  #this is a parameter to be supplied, total charge density
...
df.to_csv('cost_Analysis2_'+str(case)+'_main_6.csv')
df_2.to_csv('stream_Analysis2_table_'+str(case)+'_main_6.csv')
df_netl.to_csv('cost_netl_Analysis2_'+str(case)+'_main_6.csv')
