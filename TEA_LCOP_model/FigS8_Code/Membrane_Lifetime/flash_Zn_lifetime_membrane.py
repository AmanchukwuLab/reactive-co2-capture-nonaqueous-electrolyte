...
input_parameter = pd.read_csv('input_lifetime.csv') 
...
def processInput(i):
    ...
    os.system('cp flash_Zn_lifetime_revised1.py flash_Sn_case_'+str(i)+'.py')
    
    with open('flash_Sn_case_'+str(i)+'.py', 'r') as file:
         filedata = file.read()
    ...
    with open('flash_Sn_case_'+str(i)+'.py', 'w') as file:
         file.write(filedata)
         
    os.system('python3 flash_Sn_case_'+str(i)+'.py')
    os.system('rm flash_Sn_case_'+str(i)+'.py')   
